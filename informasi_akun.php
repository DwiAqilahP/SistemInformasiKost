  ...
  <body class="bg-dark">
    <section class="header">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
          <a class="navbar-brand" href="#"><span style="font-family: 'Pacifico', cursive;">SewaKuy</span></a>
        ...
        <div class="row">
          <div class="col-sm-4">
              <table>
                <tr>
                  <th>Nama Pemilik</th>
                  <?php echo "<td>: &nbsp;$_SESSION[nama_pemilik]</td>";?>
                </tr>
                <tr>
                  <th>Username</th>
                  <?php echo "<td>: &nbsp;$_SESSION[username_pemilik]</td>";?>
                </tr>
                <tr>
                  <th>Email</th>
                  <?php echo "<td>: &nbsp;$_SESSION[email_pemilik]</td>";?>
                </tr>
                
                <tr>
                  <th>Jenis Kelamin</th>
                  <?php echo "<td>: &nbsp;$_SESSION[gender_pemilik]</td>";?>
                </tr>
