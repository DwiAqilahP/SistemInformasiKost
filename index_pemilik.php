        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="col-sm-6" style="text-align: right; font-size: 20px;">
              <a href="kos_putra_pemilik.php" class="btn btn-primary">Selengkapnya</a>
            </div>
        </div>
        <div class="row">
          <?php 
      ...
      <div class="container bg-white">
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="col-sm-6" style="text-align: right; font-size: 20px;">
              <a href="kos_putri_pemilik.php" class="btn btn-primary">Selengkapnya</a>
            </div>
        </div>
        <div class="row">
         <?php 
          ...
          <div class="col-sm-4">
            <div class="card kartu" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <a href="kamar_login_pemilik.php?id_kamar=<?=$data1['id_kamar']?>" class="btn btn-primary">Go Kamar</a>
              </div>
            </div>
          </div>
          <?php
