...
if (isset($_POST['submit'])){
    $username = $_POST["username"];
    $password = $_POST["password"];
    $sql = "SELECT * FROM tb_pemilik WHERE username_pemilik='$username' AND password_pemilik='$password'";
    $result = mysqli_query($connect, $sql);
    if ($result->num_rows > 0) {
        $valid = mysqli_fetch_assoc($result);
        $_SESSION['id_pemilik'] = $valid['id_pemilik'];
        $_SESSION['nama_pemilik'] = $valid['nama_pemilik'];
        $_SESSION['gender_pemilik'] = $valid['gender_pemilik'];
        $_SESSION['username_pemilik'] = $valid['username_pemilik'];
        $_SESSION['email_pemilik'] = $valid['email_pemilik'];
        // $_SESSION['tgl_lahir_pemilik'] = $valid['tgl_lahir_pemilik'];
        // $_SESSION['alamat_pemilik'] = $valid['alamat_pemilik'];
...
<body>
    <div class="isi">
        ...
        <p style="margin-top: 30px;">Not a member? <a href="register.php" style="text-decoration: none;">Sign Up</a></p>
